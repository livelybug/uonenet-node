...
use hex_literal::hex;
use uonenet_runtime::{
	currency::UON, opaque::SessionKeys, Balance, BeefyConfig, ImOnlineConfig, SessionConfig,
	StakingConfig,
};
...
fn session_keys(
	babe: BabeId, // sr25519
	grandpa: GrandpaId, // ed25519
	im_online: ImOnlineId, // sr25519
	beefy: BeefyId, // ecdsa
) -> SessionKeys {
...
pub fn staging_tesnet_config() -> Result<ChainSpec, String> {
	...
	Ok(ChainSpec::from_genesis(
		...
		// ID
		"uonenet_staging_testnet",
		ChainType::Live,
		move || {
			testnet_genesis(
				// WASM Binary
				wasm_binary,
				// Sudo account, sr25519
				...
				// AccountId, ValidatorId, BabeId, GrandpaId, ImOnlineId, BeefyId
				vec![
					(
...
pub fn development_tesnet_config() -> Result<ChainSpec, String> {
	...
	Ok(ChainSpec::from_genesis(
		// Name
		"Unique One Development Testnet",
		// ID
		"uonenet_development_testnet",
		ChainType::Live,
		move || {
			testnet_genesis(
				// WASM Binary
		...
		None,
		// Protocol ID
		Some("uonenet-development-tesnet"),
		// Properties
		Some(properties),
		// Extensions
		None,
...
pub fn local_development_tesnet_config() -> Result<ChainSpec, String> {
	...
	Ok(ChainSpec::from_genesis(
		// Name
		"Unique One Local Development Testnet",
		// ID
		"uonenet_local_development_testnet",
		...
		None,
		// Protocol ID
		Some("uonenet-local-development-tesnet"),
		// Properties
		Some(properties),
		// Extensions
		None,
			...
			accounts: {
				...
				map.insert(
					...
					pallet_evm::GenesisAccount {
						balance: U256::from_str("0xD3C21BCECCEDA1000000")   // 1000000 000000000000000000
