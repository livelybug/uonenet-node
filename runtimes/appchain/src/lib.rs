...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	...
	impl_name: create_runtime_str!("uniqueone-net-appchain"),
	authoring_version: 1,
...
pub struct UONdGasWeightMapping;

impl pallet_evm::GasWeightMapping for UONdGasWeightMapping {
...
impl pallet_evm::Config for Runtime {
	...
	type GasWeightMapping = UONdGasWeightMapping;
